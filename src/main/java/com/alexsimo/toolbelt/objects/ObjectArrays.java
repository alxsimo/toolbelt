package com.alexsimo.toolbelt.objects;
...
import static com.alexsimo.toolbelt.checks.Preconditions.checkPositionIndexes;
...
public final class ObjectArrays {
  ...
  public static <T> T[] newArray(T[] reference, int length) {
    return com.alexsimo.toolbelt.collections.Platform.newArray(reference, length);
  }
  ...
  public static <T> T[] arraysCopyOf(T[] original, int newLength) {
